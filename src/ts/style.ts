...
const works: Work[] = [  //Work[] <= []がないとたった一つのという定義になる。
  {
    ...
    siteUrl: "https://coding-practice-01.vercel.app/",
    githubUrl: "https://github.com/ren12123/repo-name", // 自分のリポジトリURL
    description: "HTML/CSSの基礎を固めるために制作した、うどん屋の紹介サイトです。"
  },
  {
    title: "Gallery Project",
    thumbnail: "/hero-gall.png",
    siteUrl: "https://practice-gallery-site.vercel.app/",
    githubUrl: "https://github.com/ren12123/repo-name",
